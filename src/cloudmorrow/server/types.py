...
* **App** types an included app provides — calendars and events,
  channels and messages. (Boards, tasks and notes are datamodels now,
  served through the record API — notes by their backend — and listed at
