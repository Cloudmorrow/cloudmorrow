...
registerScreen("q", async (arg) => {
  // Whatever follows the screen is the kit's: a board's group, a list's
  // group and subgroup, a grid's group and the folder in it, a thread's
  // space and what is below it.
