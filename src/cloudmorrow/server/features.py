...
A feature is one whole area of the app — Notes, Calendar, Secrets, Files,
and every installed Quill — and there are two switches on each, which are not the same
kind of thing:
